...
<body>
    <?php require 'include/recursosJS.php' ?>
    ...
    <div class=" row align-items-center justify-content-center vh-100 mx-auto">
        <div class="container-fluid col-3 border rounded" style="padding: 0% 1% 1% 1%">
            ...
            <form action="controller/controlUsuario.php" method="POST" class="form" onsubmit="return ValidarCampos();">
                ...
                <button class="btn btn-primary form-control mt-3 p-2" type="submit" name="accion" value="Login">Iniciar Sesión</button>
            </form>
        </div>
    </div>
